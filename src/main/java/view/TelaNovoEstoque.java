...
public class TelaNovoEstoque extends JFrame {
    ...
    private void cadastrarProduto() {
        try {
            ...
            String codigo = lerCampoObrigatorio(codigoAreaText, "Digite o código do produto", "código");
            ...
            itemController.cadastrar(nome, codigo, marca, quantidadeEstoque, valorCompra, valorVenda);
